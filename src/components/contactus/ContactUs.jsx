...
const ContactUsContent = () => {
    ...
    useEffect(() => {
        ...
        if (scrollTo === 'contactUsForm' && contactUsFormRef.current) {
                ...
                <div className="flex flex-col items-center justify-center gap-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {contactOptions.map((option, index) => (
                            <AnimatedSection key={index} index={index} variant={"fadeUpVariant"} className={"min-w-[300px] md:min-w-[330px]"}>
                                <Link
                                    href={option.link}
                ...
                <div ref={contactUsFormRef} className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8 pt-8">
                    <div className="">
                        ...
                        <div
                            ...
                            <p className={"flex items-center gap-2"}><Mail size={16}/> Email: <Link href={"mailto:info@nexdecade.com"} className={"text-primary font-medium hover:underline"}>info@nexdecade.com</Link>
                            </p>
                            <p className="flex items-center gap-2">
                                <Phone size={16}/> Call For Support : <Link href="tel:+8801713189710" className="text-primary font-medium hover:underline">+8801713189710</Link>
                            </p>
                            <p className="flex items-center gap-2">
                                <Phone size={16}/> Call For Sales : <Link href="tel:+8801711204695" className="text-primary font-medium hover:underline">+8801711204695</Link>
                            </p>
