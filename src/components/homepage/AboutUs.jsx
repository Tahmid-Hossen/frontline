      ...
      <div className="container">
        <div className="row justify-between text-center lg:text-start">
          <div className="partner text-center mx-auto space-y-4 text-dark md:flex justify-between items-center">
            <div className="about-us-left md:w-[40%]">
              <img src="/images/about-us/aboutus.png" height={562} width={657} alt="logo"
                   className="w-[745px] md:h-auto"/>
            </div>
            <div className="about-us-right md:w-[60%]">
                <div className="about-us-right-content text-left">
                    <h2 className="font-bold text-5xl">About US</h2>
                    <p className="text-2xl font-normal py-6">Frotline is an Indonesian ad-tech startup providing impactful and accessible advertising solutions. Its innovative platform helps brands effectively reach and engage audiences in their daily journeys, maximizing visibility and interaction.</p>
